...
public class UTECECourses {
    ...
    public static HashMap<String,Course> initialize() {
        ...
        courses.put("EE362K", new Course("EE362K",2.5));
        ...
        courses.put("EE362S", new Course("EE362S",-1));
        courses.put("EE363N", new Course("EE363N",-1));
        courses.put("EE362Q", new Course("EE362Q",-1));
    ...
    /************************************************************
     * @name: main                                              *
     * @description: Main body to set special values and        *
     * handle highest-level logic.                              *
    ...
    public static void main(String[] args) {
        ...
        while (rpt){
            ...
            HashMap<String,Course> allCourses = initialize(); //Create initial list of courses
            ...
            /* Begin parsing */
            while(!input.equals("D")) { //While not done
                if (allCourses.containsKey(input))  {
                    ...
                    if (tempDiff == -1) {
                        ...
                        if (input.equals("EE445L")){
                            ...
                            System.out.println("\nIs Dr. Perry teaching EE422C? Y/N");
                            System.out.print(">");
                            input = sc.nextLine();
                            input = input.replaceAll("\\s+","");
                            input = input.toUpperCase();
                            ...
                            System.out.println("\nIs Dr. Chase teaching EE312? Y/N");
                            System.out.print(">");
                            input = sc.nextLine();
                            input = input.replaceAll("\\s+","");
                            input = input.toUpperCase();
                            ...
                            System.out.println("\nDid you do circuits in high school? Y/N");
                            System.out.print(">");
                            input = sc.nextLine();
                            input = input.replaceAll("\\s+","");
                            input = input.toUpperCase();
                            ...
                            System.out.println("\nIs Dr. Patt teaching EE306? Y/N"); //Patt exception
                            System.out.print(">");
                            input = sc.nextLine();
                            input = input.replaceAll("\\s+","");
                            input = input.toUpperCase();
